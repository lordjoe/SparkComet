...
public class MGFInputFormat extends FileInputFormat<String, String> implements Serializable {
     ...
     */
    public   class MGFFileReader extends RecordReader<String, String> {
        ...
        public void initialize(InputSplit genericSplit,
            ...
            numberSpectra = context.getConfiguration().getInt("numberSpectrs",200);
        ...
        public boolean nextKeyValue() throws IOException {
            ...
            while (m_FileIn.getPos() < m_End   && !m_CurrentLine.startsWith("BEGIN IONS")) {
                m_CurrentLine = readNextLine();
            }

            if (m_CurrentLine == null || !m_CurrentLine.startsWith("BEGIN IONS")) {  // we are the the end of data
                m_Key = null;
                m_Value = null;
                return false;
            }
