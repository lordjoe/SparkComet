...
/**
 * com.lordjoe.distributed.input.MultiMGFInputFormat
 * User: Steve
 * Date: 9/24/2014
 */
public class MultiMGFInputFormat extends FileInputFormat<String, String> implements Serializable {
    ...
    public class MultiMGFFileReader extends RecordReader<String, String> {
        ...
        private int m_spectraToHandle;
        private int numberReadSpectra;
        ...
        public boolean nextKeyValue() throws IOException {
            ...
            if (m_CurrentLine == null || !m_CurrentLine.startsWith(START_STRING)) {  // we are the the end of data
                return false;
            }
        ...
        private boolean readNextField() throws IOException {
            ...
            m_CurrentLine = readNextLine();
            // keep reading
            while (m_CurrentLine != null && !m_CurrentLine.startsWith(START_STRING)) {
                m_Data.append(m_CurrentLine);
                m_Data.append("\n");
                m_CurrentLine = readNextLine();
